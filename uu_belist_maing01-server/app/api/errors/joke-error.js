...
const JokesMainUseCaseError = require("./belist-main-use-case-error");
...
const List = {
  ...
  JokesMainDoesNotExist: class extends JokesMainUseCaseError {
    constructor() {
      ...
      this.message = "UuObject jokesMain does not exist.AAAAAAAAAAAAAAAA";
    }
  },
...
const Get = {
  ...
  JokesMainDoesNotExist: class extends JokesMainUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${Get.UC_CODE}jokesMainDoesNotExist`;
  ...
  JokesMainNotInCorrectState: class extends JokesMainUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${Get.UC_CODE}jokesMainNotInCorrectState`;
      this.message = "UuObject jokesMain is not in correct state.";
    }
  },
...
const Create = {
  ...
  JokesMainDoesNotExist: class extends JokesMainUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${Create.UC_CODE}jokesMainDoesNotExist`;
      this.message = "UuObject jokesMain does not exist.";
    }
  },
  JokesMainNotInCorrectState: class extends JokesMainUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${Create.UC_CODE}jokesMainNotInCorrectState`;
      this.message = "UuObject jokesMain is not in correct state.";
    }
  },
...
const Update = {
  ...
  JokesMainDoesNotExist: class extends JokesMainUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${Update.UC_CODE}jokesMainDoesNotExist`;
      this.message = "UuObject jokesMain does not exist.";
    }
  },
  JokesMainNotInCorrectState: class extends JokesMainUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${Update.UC_CODE}jokesMainNotInCorrectState`;
      this.message = "UuObject jokesMain is not in correct state.";
    }
  },
...
const Delete = {
  ...
  JokesMainDoesNotExist: class extends JokesMainUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${Delete.UC_CODE}jokesMainDoesNotExist`;
      this.message = "UuObject jokesMain does not exist.";
    }
  },
  JokesMainNotInCorrectState: class extends JokesMainUseCaseError {
    constructor() {
      super(...arguments);
      this.code = `${Delete.UC_CODE}jokesMainNotInCorrectState`;
      this.message = "UuObject jokesMain is not in correct state.";
    }
  },
  JokeDoesNotExist: class extends JokesMainUseCaseError {
