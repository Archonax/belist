...
const Errors = require("../api/errors/belist-main-error.js");
...
const logger = LoggerFactory.get("BelistMainAbl");*/
...
module.exports = new BelistMainAbl();*/
//_____________________________________________________________________________
/*const { Validator } = require("uu_appg01_server").Validation;
const { ValidationHelper } = require("uu_appg01_server").AppServer;
const { DaoFactory } = require("uu_appg01_server").ObjectStore;
const { Profile } = require("uu_appg01_server").Workspace;
const Errors = require("../api/errors/belist-main-error");
...
class BelistMainAbl {
  constructor() {
    this.validator = Validator.load();
    this.dao = DaoFactory.getDao(Schemas.BELIST_MAIN);
