...
db.joke.insert({
  ...
  averageRating: 4,
  ratingCount: 1,
  uuIdentity: "7337-1132-7592-0000", // add your uuIdentity (22-2312-1)
  uuIdentityName: "Test Name", // add your uuIdentity name (Holly Hudson)
...
db.joke.insert({
  _id: ObjectId("61e1574817f0e248baf15f71"),
  name: "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB",
  image: null,
  text: "Why did the BBBBBBBBBBBBBBB? Because he BBBBBBBBBBBB",
  averageRating: 4,
  ratingCount: 1,
  uuIdentity: "7337-1132-7592-0000", // add your uuIdentity (22-2312-1)
  uuIdentityName: "Test Nametwo", // add your uuIdentity name (Holly Hudson)
  awid: "22222222222222222222222222222222",
  sys: { cts: "2021-11-08T14:17:41.202Z", mts: "2022-03-01T15:07:00.989Z", rev: 0 },
  visibility: true,
  categoryIdList: [],
